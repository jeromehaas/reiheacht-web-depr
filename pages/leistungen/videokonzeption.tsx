...
const Videokonzeption: React.FunctionComponent<Props> = () => (
  <Service>
    ...
    <Space height="20px" />
    <H4 color="white" fullWidth>Auf die Idee folgt die Planung</H4>
    <Space height="20px" />
    ...
    <Space height="20px" />
    <H4 fullWidth>Wir legen das Fundament</H4>
    <Space height="20px" />
    ...
    <Space height="20px" />
    <P fullWidth>Darum gilt es, bereits in der Konzeptionsphase Ziele, Termine, Meilensteine und Zielgruppen und die richtige Videoart zu definieren, sprich <NextLink href="/leistungen/sound-design"><a className="link--service">Motion Design</a></NextLink>, <NextLink href="/leistungen/erklaervideo"><a className="link--service">Erklärvideo</a></NextLink>, <NextLink href="/leistungen/werbe-und-imagefilm"><a className="link--service"> Werbe- oder Imagefilm</a></NextLink>.</P>
    <Space height="20px" />
    <P fullWidth>Dazu kommen noch viele weitere Punkte, nur um einige zu nennen, wie Bildformate, Sprachen, Design, <NextLink href="/leistungen/sound-design"><a className="link--service">Sound Design</a></NextLink>, Bewilligungen, Rechte, den passenden Voice Over Artist und Schauspieler Casting.</P>
    <Space height="20px" />
    <H4 fullWidth>Ziel: Zielgruppe wirksam treffen</H4>
    <Space height="20px" />
