...
const SoundDesign: React.FunctionComponent<Props> = () => (
  <Service>
    ...
    <Space height="20px" />
    <H4 color="white" fullWidth>Den richtigen Ton treffen</H4>
    <Space height="20px" />
    ...
    <Space height="20px" />
    <P fullWidth>In Spielfilmen sowie Werbe- oder Imagefilmen längst im Einsatz, wird es im Motion Design oft noch vernachlässigt. Bei realen Bildern erwarten und kennen wir die natürlichen Geräusche. Wir wissen, wie Fahrzeuge im Verkehr, Fusstritte oder singende Vögel zu klingen haben. Da <NextLink href="/leistungen/motion-design"><a className="link--service">Animationen</a></NextLink> von Grund auf kreiert werden und oft abstrakte Formen enthalten, deren Geräusche wir nicht unbedingt kennen, bedarf es einer Vertonung. Es kann kein Audio direkt von der Quelle aufgezeichnet werden. </P>
    <Space height="20px" />
    <H4 fullWidth>Storytelling mit Audio</H4>
    <Space height="20px" />
    ...
    <Space height="20px" />
    <H4 fullWidth>Die vier Aspekte des Sound Designs</H4>
    <Space height="20px" />
